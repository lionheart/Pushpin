...
Readability.prototype = {
  ...
  REGEXPS: {
    unlikelyCandidates: /combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|sponsor|ad-break|agegate|pagination|pager|popup|tweet|twitter|addthis/i,
    okMaybeItsACandidate: /and|article|body|column|main|shadow|primary/i,
    positive: /article|body|primary|content|entry|hentry|main|page|pagination|post|text|blog|story|row/i,
    ...
    byline: /byline|editor|author|dateline|writtenby/i,
...
readable = new Readability(document.location.href, document)
content = readable.parse()
