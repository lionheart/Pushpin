...
convert "Assets/Icon~iphone.png" -draw "image over 0,0 57,57 'Assets/Beta-Overlay.png'" "Assets/Icon-beta~iphone.png"
convert "Assets/Icon@2x~iphone.png" -draw "image over 0,0 114,114 'Assets/Beta-Overlay.png'" "Assets/Icon-beta@2x~iphone.png"
convert "Assets/Icon~ipad.png" -draw "image over 0,0 57,57 'Assets/Beta-Overlay.png'" "Assets/Icon-beta-ipad.png"
convert "Assets/Icon@2x~ipad.png" -draw "image over 0,0 114,114 'Assets/Beta-Overlay.png'" "Assets/Icon-beta@2x~ipad.png"
...
convert "Assets/Icon~iphone.png" -draw "image over 0,0 57,57 'Assets/Dev-Overlay.png'" "Assets/Icon-dev~iphone.png"
convert "Assets/Icon@2x~iphone.png" -draw "image over 0,0 114,114 'Assets/Dev-Overlay.png'" "Assets/Icon-dev@2x~iphone.png"
convert "Assets/Icon~ipad.png" -draw "image over 0,0 57,57 'Assets/Dev-Overlay.png'" "Assets/Icon-dev~ipad.png"
convert "Assets/Icon@2x~ipad.png" -draw "image over 0,0 114,114 'Assets/Dev-Overlay.png'" "Assets/Icon-dev@2x~ipad.png"
