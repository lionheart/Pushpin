...
- (id)initWithTitle:(NSString *)title inView:(UIView *)view {
    if (self = [super initWithFrame:CGRectMake(0, view.bounds.size.height, [UIScreen mainScreen].bounds.size.width, 40)]){
...
- (id)initWithTitle:(NSString *)title{
    if (self = [super initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 40)]){
