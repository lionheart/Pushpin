...
if [[ "$CONFIGURATION" == "Beta" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LHSCategoryCollection/LHSCategoryCollection.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LHSFMDatabaseAdditions/LHSFMDatabaseAdditions.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LHSKeyboardAdjusting/LHSKeyboardAdjusting.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Beacon/Beacon.framework"
fi
