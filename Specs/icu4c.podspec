Pod::Spec.new do |s|
  ...
  s.compiler_flags = '-DU_COMMON_IMPLEMENTATION -DU_I18N_IMPLEMENTATION -DU_IO_IMPLEMENTATION -Wno-error=shorten-64-to-32 -Wno-error=unused-const-variable'
  ...
  s.prepare_command = <<-CMD
    ...
    cd common ; make install-headers includedir="$DIR/Headers/icu4c" > /dev/null 2>&1; cd ..
    cd i18n ; make install-headers includedir="$DIR/Headers/icu4c" > /dev/null 2>&1; cd ..
    cd io ; make install-headers includedir="$DIR/Headers/icu4c" > /dev/null 2>&1; cd ..
    cd layout ; make install-headers includedir="$DIR/Headers/icu4c" > /dev/null 2>&1; cd ..
    cd layoutex ; make install-headers includedir="$DIR/Headers/icu4c" > /dev/null 2>&1; cd ..

    cd common ; make install-headers includedir="$DIR/BuildHeaders/icu4c" > /dev/null 2>&1; cd ..
    cd i18n ; make install-headers includedir="$DIR/BuildHeaders/icu4c" > /dev/null 2>&1; cd ..
    cd io ; make install-headers includedir="$DIR/BuildHeaders/icu4c" > /dev/null 2>&1; cd ..
    cd layout ; make install-headers includedir="$DIR/BuildHeaders/icu4c" > /dev/null 2>&1; cd ..
    cd layoutex ; make install-headers includedir="$DIR/BuildHeaders/icu4c" > /dev/null 2>&1; cd ..
    cd ..
